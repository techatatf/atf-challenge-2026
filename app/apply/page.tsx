...
export const metadata: Metadata = {
  ...
  description:
    "Apply for the ATF AI Challenge — Africa's largest hands-on AI program. Registration closes June 15.",
};
        ...
        <section className="py-12 md:py-20 px-4 md:px-8 lg:px-16 bg-foreground text-background">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-background/70 max-w-2xl mx-auto">
              ...
              <span className="text-primary font-semibold">June 15, 2026</span>.
            </p>
          </div>
        </section>
